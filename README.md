...
- Switches between the full 320 × 320 panel and the original compact 100 × 100 quota orb from an in-panel control, preserving the chosen size across restarts.
