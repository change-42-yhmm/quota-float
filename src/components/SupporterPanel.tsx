...
const labels = { "zh-CN": { title: "版本更新", description: "现已支持 Claude 订阅与 API、GPT API 额度读取，Mac 状态栏可显示额度；新增 Glass 与 Nexus 两款皮肤供选择。", supporterSkins: "设计师皮肤", choose: "1. 皮肤预览", device: "2. 皮肤名称和复制设备码和给设计师", creatorPlatforms: "设计师联系方式", license: "3. 收到反馈的许可证粘贴解锁", copy: "复制", copied: "已复制", loadingCode: "正在生成设备码…", codeUnavailable: "设备码暂时不可用", copyFailed: "复制失败，请重试。", owned: "拥有", placeholder: "粘贴完整的许可证 JSON", activate: "验证许可证", working: "正在验证…", ready: "皮肤可以在系统托盘选择。", verifying: "正在验证许可证与当前设备，请稍候。", activated: "许可证验证成功，已解锁对应皮肤。请在系统托盘主题菜单中启用。", failed: "许可证验证失败，请稍后重试。" }, en: { title: "Version updates", description: "Claude subscriptions and API, GPT API quota tracking, and Mac menu-bar quota display are now supported. Glass and Nexus skins are also available.", supporterSkins: "Designer skins", choose: "1. Skin preview", device: "2. Send the skin name and copied device code to the designer", creatorPlatforms: "Designer contact", license: "3. Paste the received license to unlock", copy: "Copy", copied: "Copied", loadingCode: "Generating device code…", codeUnavailable: "Device code is temporarily unavailable", copyFailed: "Copy failed. Try again.", owned: "Owned", placeholder: "Paste the complete license JSON", activate: "Verify license", working: "Verifying…", ready: "Choose skins from the system tray.", verifying: "Verifying the license for this device…", activated: "License verified. Enable the unlocked skin from the system-tray Theme menu.", failed: "License verification failed. Try again shortly." } } as const;
type PreviewSkin = Exclude<WidgetSkin, "default">;
const choices: Array<{ id: PreviewSkin; name: Record<Language, string>; price: string; thumbnail?: string }> = [{ id: "blur", name: { "zh-CN": "Blur", en: "Blur" }, price: "¥1.99", thumbnail: blurThumbnailUrl }, { id: "computer", name: { "zh-CN": "Computer", en: "Computer" }, price: "¥3.99", thumbnail: computerThumbnailUrl }, { id: "glass", name: { "zh-CN": "Glass", en: "Glass" }, price: "¥4", thumbnail: glassThumbnailUrl }, { id: "nexus", name: { "zh-CN": "Nexus", en: "Nexus" }, price: "¥8", thumbnail: nexusThumbnailUrl }];
