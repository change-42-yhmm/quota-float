...
type Skin = "blur" | "computer" | "glass" | "nexus";
const skinNames = { blur: "Blur", computer: "Computer", glass: "Glass", nexus: "Nexus" };
const skinDescriptions = { blur: "柔焦渐变", computer: "像素终端", glass: "通透玻璃", nexus: "机械终端" };
