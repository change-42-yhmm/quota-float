...
ReactDOM.createRoot(document.getElementById("root")!).render(
  <React.StrictMode>{showDesigner && DesignPlayground ? <React.Suspense fallback={null}><DesignPlayground /></React.Suspense> : showSupporter ? <SupporterPanel preview={supporterPreview} onStatus={() => {}} /> : <App />}</React.StrictMode>,
);
